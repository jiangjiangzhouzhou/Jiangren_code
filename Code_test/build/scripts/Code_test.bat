...
@rem ##########################################################################
@rem
@rem  Code_test startup script for Windows
@rem
@rem ##########################################################################
...
set CLASSPATH=%APP_HOME%\lib\Code_test-1.0-SNAPSHOT.jar


@rem Execute Code_test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CODE_TEST_OPTS%  -classpath "%CLASSPATH%" bundle_calculator.Calculator %*
